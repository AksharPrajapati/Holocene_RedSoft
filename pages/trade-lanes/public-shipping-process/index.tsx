...
import { getGeneralGuidelinesTableData } from "../../../MockData/Tradelanes";
...
const tableTabs: ITab[] = [{ label: "General Guidelines", number: 41 }];
...
export const PublicShippingProcesses = () => {
  ...
  return (
    <PageWrapper>
      <div className="">
        <Header searchText="Find Shipments public" tabs={<HeaderTabs />} />
      </div>
        ...
        <div className="mx-10 bg-white ring-1 ring-black ring-opacity-5 shadow rounded-lg">
          ...
          {selectedTab.label === "General Guidelines" ? (
            <GeneralGuidelinesTable
              ...
              tableData={generalGuidelinesTableData}
            />
          ) : (
            ""
          )}
...
export default PublicShippingProcesses;
